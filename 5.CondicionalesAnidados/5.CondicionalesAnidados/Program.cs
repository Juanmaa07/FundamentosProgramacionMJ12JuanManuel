...
namespace _5.CondicionalesAnidados
{
    internal class Program
    {
        ...
        {
            //Concidcionales Anidados
            //Diseñar un algoritmo que lea tres números A, B y C y que visualice en pantalla el valor más grande. El usuario debe ingresar tres valores diferentes.
            int num1 = 0;
            int num2 = 0;
            int num3 = 0;
