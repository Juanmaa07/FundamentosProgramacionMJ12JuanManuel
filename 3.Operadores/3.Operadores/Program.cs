...
namespace _3.Operadores
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int dato1 = 0;
            dato1++;//dato 1 = dato 1 + 1; Incremento en 1 unidad
            dato1--; //dato1 = dato 1 - 1; Decremento en 1 unidad
            dato1 += 15;//dato1 = dato1 + 15;
            dato1 -= 14;//dato1 = dato1 - 14;
            dato1 *= 3; //dato1 = dato1 * 3
            dato1 /= 3;//dato1 = dato1 / 2
            dato1 *= dato1;

            //Orden de evaluación de operadores automáticos
            int dato2 = 4 * 3 / 2;
